...
export const registerSchema = z.object({
    username: z.string().trim().min(3, { message: "Username min 3 Character" }).max(250, {message:"Username Have Reached Maximum Length"}).regex(/^[A-Za-z\s]+$/i, "Only Letters are Allowed"),
